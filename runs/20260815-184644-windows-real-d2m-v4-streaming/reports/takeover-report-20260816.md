...
|---|---:|---:|---:|---|---|
| p16/top4 | 0.921769 → 0.922414 | 0.131389 → 0.130771 | 0.712610 → 0.661438 | `BASIS_QUALITY` | `REFINING` |
| p32/top5 | 0.921811 → 0.922321 | 0.133187 → 0.132791 | 1.140175 → 1.166190 | `BASIS_QUALITY` | `REFINING` |
