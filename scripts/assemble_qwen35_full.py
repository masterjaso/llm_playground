...
from dense2moe.models.qwen35_full import Qwen35DenseToMoE
...
def assemble(*, run_dir: Path, profile: str, source_dir: Path | None, strict: bool) -> dict[str, Any]:
    ...
    try:
        ...
        receipt.update({"status": "BF16_SPARSE_MASTER_ASSEMBLED", "profile": profile, "strict": strict, "destination": str(destination), "full64_checkpoint_manifest": str(checkpoint_manifest)})
