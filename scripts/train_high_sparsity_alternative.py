...
def _run(args: argparse.Namespace) -> dict[str, Any]:
    ...
    payload = {
        "schema_version": 1,
        "status": "ALTERNATIVE_HIGH_SPARSITY_TRAIN_DEV_COMPLETE",
        "classification": "TRAIN_DEV_PARTITION_COMPARISON_HOLDOUT_DEFERRED",
        "profile": profile.name,
        "partition": str(partition),
        "partition_strategy": args.partition_name,
        "selection_split": "train_split" if selection_indices is None else "train_dev",
