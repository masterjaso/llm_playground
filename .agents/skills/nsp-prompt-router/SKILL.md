...
3. Route planning to Genesis, implementation to Build, defects to Debug, explanation to Berean, first adoption to Adopt, diff alignment to Maintain, cleanup to Clean, and final review to Review. These are the eight public entries. Upgrade is lifecycle-triggered; workers, orchestration, prose, and prototype are internal.
